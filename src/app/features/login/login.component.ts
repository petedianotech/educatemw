  ...
  template: `
    <div class="min-h-screen bg-slate-50 flex flex-col py-12 sm:px-6 lg:px-8 relative overflow-x-hidden overflow-y-auto pb-safe">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-md relative z-10">
        <div class="bg-white/90 backdrop-blur-xl py-8 px-6 shadow-2xl shadow-indigo-100 sm:rounded-[2.5rem] sm:px-10 border border-white/40">
          
          <!-- Google Login First -->
          <div class="mb-8">
            <button (click)="loginWithGoogle()" type="button" 
                    class="w-full py-4 bg-white border-2 border-slate-100 rounded-2xl flex items-center justify-center gap-3 text-[15px] font-bold text-slate-700 hover:bg-slate-50 hover:border-indigo-100 active:scale-[0.98] transition-all shadow-sm">
          ...
          <div class="flex p-1.5 bg-slate-100/80 rounded-2xl mb-6 border border-slate-200/50">
          ...
          <form (ngSubmit)="submitForm()" class="space-y-4">
            ...
            <div class="pt-4">
              <button type="submit" [disabled]="isLoading()" 
                      class="btn-primary w-full py-4 text-[15px] shadow-xl shadow-indigo-200 active:scale-[0.98] transition-all">
          ...
          <div class="mt-8 text-center">
            <button (click)="toggleSignup()" type="button" class="text-xs font-black uppercase tracking-widest text-slate-400 hover:text-indigo-600 transition-colors">
