    ...
    <div class="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div class="mt-16 max-w-lg mx-auto relative z-10">
        <div class="card-modern overflow-hidden">
          <div class="px-6 py-8 bg-indigo-50/50 border-b border-slate-100 sm:p-10 sm:pb-6">
            <div class="flex justify-center">
              <span class="inline-flex px-4 py-1 rounded-xl text-sm font-bold tracking-wide uppercase bg-indigo-100 text-indigo-800 border border-indigo-200 shadow-sm">
                Pro Plan
              </span>
            </div>
            <div class="mt-4 flex justify-center text-6xl font-bold text-slate-900">
              <span class="ml-1 text-xl font-semibold text-slate-500 mt-2">MWK</span>
              5,000
              <span class="ml-1 text-xl font-semibold text-slate-500 mt-auto mb-2">/mo</span>
            </div>
          </div>
          <div class="px-6 pt-6 pb-8 bg-white sm:p-10 sm:pt-6">
            <ul class="space-y-4">
              <li class="flex items-start">
                ...
                <p class="ml-3 text-base text-slate-700 font-medium">Unlimited AI Tutor Chat</p>
              </li>
              <li class="flex items-start">
                <div class="flex-shrink-0">
                  <mat-icon class="text-indigo-600">check_circle</mat-icon>
              ...
              <li class="flex items-start">
                ...
                <p class="ml-3 text-base text-slate-700 font-medium">Priority Community Support</p>
              </li>
              <li class="flex items-start">
                <div class="flex-shrink-0">
                  <mat-icon class="text-indigo-600">check_circle</mat-icon>
                </div>
                <p class="ml-3 text-base text-slate-700 font-medium">Offline Downloads</p>
              </li>
            </ul>
            <div class="mt-8">
              <button (click)="simulateUpgrade()" class="btn-primary w-full py-4 text-[16px] flex items-center justify-center gap-2">
